...
class TestFour(unittest.TestCase):
    ...
    def test_01_get_data_initial(self):
    ...
    def test_03_get_data_after_adding_user(self):
    ...
    def test_05_get_nonexistent_user(self):
    ...
    def test_07_add_user_without_username(self):
    ...
    def test_08_add_user_duplicate_username(self):
